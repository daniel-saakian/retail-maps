...
const luckysheetFontHost = "https://at.alicdn.com";
 
const csp = [
    `default-src 'self'`,
    `script-src ${scriptSrc} ${cdnHost}`,
    `style-src 'self' 'unsafe-inline' ${cdnHost}`,
    `img-src 'self' data: https:`,
    `font-src 'self' data: ${cdnHost} ${luckysheetFontHost}`,
    `connect-src ${connectSrc} ${cdnHost}`,
