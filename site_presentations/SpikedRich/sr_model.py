...
competitor_csv = str(_this_dir / "competitors_sr.csv")

sr_primary_competitor_brands = [
    "Tipsy Scoop", "Aubi & Ramsa", "Clementine's Creamery", "Salt & Straw", "Jeni's", "Handel's"
]

def load_sr_competitor():
