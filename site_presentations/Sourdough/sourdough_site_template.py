...
fbanner_sub = Font(name = "Montserrat", size = 12, bold = True, color = slate)
faddress = Font(name = "Georgia", size = 14, bold = True, color = burgundy)
fsubtit = Font(name = "Arial", size = 10, bold = False, color = brown)
fsection_head = Font(name = "Montserrat", size = 11, bold = True, color = white)
ftable_head = Font(name = "Arial", size = 10, bold = True, color = slate)
fbody = Font(name = "Roboto", size = 10, bold = False)
 
fill_darkred = PatternFill("solid", start_color = Dark_red)
fill_titlesub = PatternFill("solid", start_color = title_cream)
fill_peach = PatternFill("solid", start_color = peach)
...
def build_excel_report(profile:dict, scores:dict, address:str, traffic:dict|None = None,proximity:list|None= None, competitors:list|None = None,
    ...
    base = f"SD&Co. - {city_state} Site Summary"
