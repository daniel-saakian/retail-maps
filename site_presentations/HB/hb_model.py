...
competitor_csv = str(_this_dir / "competitors_hb.csv")

hb_primary_competitor_brands = [
    "nekter", "Vitality Bowls", "Joe & The Juice", "Pressed", "Smoothie King"
]

def load_hb_competitor():
