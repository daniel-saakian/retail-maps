...
competitor_csv = str(_this_dir / "competitors_my.csv")

madyolks_primary_competitor_brands = [
    "eggslut", "Mimosa House", "Egghead", "Egg Tuck", "Hatched", "EggBred", "Egg Drop"
]

def load_madyolks_competitor():
