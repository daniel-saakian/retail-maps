...
competitor_csv = str(_this_dir / "competitors_ugt.csv")

ugt_primary_competitor_brands = [
    "Molly Tea", "CHAGEE", "HeyTea", "Chi Cha San Chen", "ShareTea"
]

def load_ugt_competitor():
