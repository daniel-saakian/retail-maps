...
fbanner_title = Font(name = "Comic Sans MS", size = 20, bold = True, color = asparagus)
fbanner_sub = Font(name = "Montserrat", size = 12, bold = True, color = dark_green)
faddress = Font(name = "Georgia", size = 14, bold = True, color = pickle)
fsubtit = Font(name = "Arial", size = 10, bold = False, color = dark_green)
fsection_head = Font(name = "Montserrat", size = 11, bold = True, color = white)
ftable_head = Font(name = "Arial", size = 10, bold = True, color = dark_green)
fbody = Font(name = "Roboto", size = 10, bold = False)
 
fill_darkred = PatternFill("solid", start_color = seaweed)
fill_titlesub = PatternFill("solid", start_color = artichoke)
fill_sand = PatternFill("solid", start_color = gin_green)
...
def build_excel_report(profile:dict, scores:dict, address:str, traffic:dict|None = None,proximity:list|None= None, competitors:list|None = None,
    ...
    base = f"UGT - {city_state} Site Summary"
