...
competitor_csv = str(_this_dir / "competitors_st.csv")

st_primary_competitor_brands = [
    "HeyTea", "Boba Guys", "Gong Cha", "Kung Fu Tea"
]

def load_st_competitor():
