...
competitor_csv = str(_this_dir / "competitors_p.csv")

poke_house_primary_competitor_brands = [
    "Poke Bros", "Pokeworks", "Poki Bowl", "Sweetfin", "Uncle Sharkii Poke Bar"
]

def load_poke_house_competitor():
...
if __name__ == "__main__":
    comp = load_poke_house_competitor()
