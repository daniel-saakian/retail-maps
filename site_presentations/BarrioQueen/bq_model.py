...
competitor_csv = str(_this_dir / "competitors_bq.csv")

barrio_queen_primary_competitor_brands = [
    "On The Border Mexican Grill & Cantina", "Rosa Mexicano", "Chuy's", "Blanco Cocina + Cantina", "Sol Mexican Cocina", "Tocaya", "Javier's", "Zocalo", "Puesto", "Reposado"
]

def load_barrio_queen_competitor():
...
if __name__ == "__main__":
    comp = load_barrio_queen_competitor()
