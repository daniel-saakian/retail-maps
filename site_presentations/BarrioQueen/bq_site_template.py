...
fbanner_title = Font(name = "Comic Sans MS", size = 20, bold = True, color = flax)
fbanner_sub = Font(name = "Montserrat", size = 12, bold = True, color = obsidian)
faddress = Font(name = "Georgia", size = 14, bold = True, color = charcoal)
fsubtit = Font(name = "Arial", size = 10, bold = False, color = obsidian)
fsection_head = Font(name = "Montserrat", size = 11, bold = True, color = white)
ftable_head = Font(name = "Arial", size = 10, bold = True, color = obsidian)
fbody = Font(name = "Roboto", size = 10, bold = False)
 
fill_darkred = PatternFill("solid", start_color = black)
fill_titlesub = PatternFill("solid", start_color = slate)
fill_sand = PatternFill("solid", start_color = light_gray)
...
def build_excel_report(profile:dict, scores:dict, address:str, traffic:dict|None = None,proximity:list|None= None, competitors:list|None = None,
    ...
    base = f"Barrio Queen - {city_state} Site Summary"
